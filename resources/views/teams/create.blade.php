    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <form action="{{ route('teams.store') }}" method="POST" class="max-w-sm mx-auto" enctype="multipart/form-data">
            ...
            <div class="flex justify-between mb-5">
                <a href="{{ route('teams.index') }}" class="text-white bg-gray-700 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
                    Back</button>
                </a>
