...
<body class="bg-gray-100">
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <h2 class="text-xl font-semibold mb-4 text-blue-500">New Team Register</h2>
        </div>
        <div class="flex justify-center mt-8">
        ...
        <form action="{{ route('teams.store') }}" method="POST" class="max-w-sm mx-auto">
            ...
            <a href="{{ route('teams.index') }}" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Back</button>
            </a>
